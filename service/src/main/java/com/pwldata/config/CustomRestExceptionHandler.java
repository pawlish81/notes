...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ NoteNotFoundException.class , NoteValidationException.class})
    public ResponseEntity<Object> handleNoteNotFoundException (final RuntimeException ex, final WebRequest request) {
        logger.error(ex.getLocalizedMessage());
        logger.error("error", ex);
        final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, ex.getLocalizedMessage(), "Incorrect note parameters");
        return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
    }
